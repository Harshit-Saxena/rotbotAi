...
from rotbot.core.session import Session
from rotbot.shared.context_analyzer import analyze_context


DEFAULT_SYSTEM_PROMPT = (
    "You are rotbot, a helpful AI assistant. You are friendly, concise, and knowledgeable. "
...
MODE_PROMPTS = {
    ...
    "coding": (
        "You are rotbot in coding mode. You are an expert software engineer. "
    ...
    "reasoning": (
        "You are rotbot in reasoning mode. Think step by step through problems. "
