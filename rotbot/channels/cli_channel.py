"""CLI channel — interactive terminal chat for `rotbot agent`."""

import asyncio
import sys
import logging

from rotbot.channels.base import BaseChannel
from rotbot.core.bus import MessageBus, StreamChunk, OutboundMessage

logger = logging.getLogger(__name__)


class CLIChannel(BaseChannel):
    """Interactive terminal channel for `rotbot agent` mode."""
    ...
    async def run_interactive(self) -> None:
        ...
        print("\nrotbot - the open agent framework for every platform")
