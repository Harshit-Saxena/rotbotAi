"""rotbot provider — manage LLM providers."""

from rich.console import Console
from rich.table import Table
from rich.prompt import Prompt

from rotbot.core.config import load_config, save_config
from rotbot.providers.openai_compat import KNOWN_PROVIDERS
...
async def run_provider(action: str | None = None):
    ...
    if action == "add":
        ...
        console.print("Usage: rotbot provider [add|list|login]")
