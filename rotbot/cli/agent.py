"""rotbot agent — interactive CLI chat mode."""
...
from rotbot.channels.cli_channel import CLIChannel
...
async def run_agent(message: str | None = None, no_markdown: bool = False, show_logs: bool = False):
    ...
    try:
        ...
        console.print("Run [cyan]rotbot onboard[/cyan] to configure a provider.")
        return
